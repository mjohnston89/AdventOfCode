print('Advent of Code - Day 21, Challenge 2\n')
...
# calculate the maximum cost to lose the fight
maxCost = max([w.cost+a.cost+r[0].cost+r[1].cost
				for w in weapons 
				for a in armour 
				for r in combinations(rings,2) 
				if (99//bossDamage(w,a,r)) <= (boss[0]//playerDamage(w,a,r))
			])
